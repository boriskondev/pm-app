...
const AddProject = () => {
  ...
  useEffect(() => {
    fetchWrapper.get(endpoints.CLIENTS).then((data) => setClientsOptions(data));
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    const selectedClient = await fetchWrapper.get(
    ...
    fetchWrapper.post(endpoints.PROJECTS, newProjectToAdd).then(() => {
